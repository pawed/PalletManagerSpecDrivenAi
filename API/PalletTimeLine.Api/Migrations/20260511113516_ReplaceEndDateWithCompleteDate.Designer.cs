...
namespace PalletTimeLine.Api.Migrations
{
    ...
    [Migration("20260511113516_ReplaceEndDateWithCompleteDate")]
    partial class ReplaceEndDateWithCompleteDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PalletTimeLine.Api.Models.TaskComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PalletTimeLine.Api.Models.TaskComment", b =>
                {
                    b.HasOne("PalletTimeLine.Api.Models.User", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PalletTimeLine.Api.Models.TaskItem", "TaskItem")
                        .WithMany("Comments")
