...
const Costs = ({ lang, costs, revenue }) => {
  const t = I18N[lang];
    ...
    <>
      ...
      {tab === "costs" && (
        <div className="card" style={{ marginTop: 20 }}>
          ...
          {costs.map(c => (
            <div key={c.id} style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 10, padding: "8px 0", borderTop: "1px solid var(--border)", alignItems: "center" }}>
      ...
      {tab === "revenue" && (
        <div className="card" style={{ marginTop: 20 }}>
          ...
          {revenue.map(r => (
            <div key={r.id} style={{ display: "grid", gridTemplateColumns: "1fr auto", gap: 10, padding: "8px 0", borderTop: "1px solid var(--border)", alignItems: "center" }}>
